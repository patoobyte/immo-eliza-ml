...
def build_model_pipeline():
    print("[STARTING] Building XGBoost pipeline...")
    ...
    print("[COMPLETED] XGBoost pipeline")
    return model_pipeline

def train_model(model_pipeline, X_train, y_train):
    print("[STARTING] Training XGBoost model...")
    model_pipeline.fit(X_train, y_train)
    print("[COMPLETED] Trained XGBoost model")
    return model_pipeline
...
def evaluate_model(model_pipeline, X_test, y_test):
    ...
    print("\nXGBoost Worst prediction errors:")
    print(
        errors
